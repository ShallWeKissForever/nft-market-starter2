...
const NFTDetail = () => {
  ...
  const handleBuyClick = async () => {
    if (allowance === 0) {
      await approve("0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2", "10000000000000000000000");
    } else {
      await buy(tokenId);
    }
  };
  ...
  useEffect(() => {
    const getInfo = async () => {
      ...
      const allowance = await getAllowance(address, "0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2");
